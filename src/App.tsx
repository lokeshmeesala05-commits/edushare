...
function App() {
  ...
  return (
    <ThemeProvider>
      <AuthProvider>
        <Router>
          <div className="min-h-screen w-full overflow-x-hidden bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-white flex flex-col font-sans transition-colors duration-200">
          {/* Offline banner */}
          {!isOnline && (
